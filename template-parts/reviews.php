...
<div class="reviews" id="reviews" style="background-image: url('<?php echo get_template_directory_uri(); ?>/dist/img/reviews/bg.jpg')">
   <div class="container">
            ...
            <div class="reviews__slider-wrapper swiper-wrapper">
               ...
               ?>
                  <div class="reviews__item swiper-slide">
                     <div class="client">
                        <div class="avatar"><img src="<?php echo esc_url($image['sizes']['thumbnail']); ?>" alt="<?php echo esc_url($image['alt']); ?>"></div>
                        <div>
